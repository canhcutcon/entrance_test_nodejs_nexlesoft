...
const validateSignIn = async ({ email, password }) => {
    if (!(authValidate.validEmail(email)) || !authValidate.validatePassword(password))
        throw new MyError('Login invalid!');
